...
class Assignment extends \VolunteerManager\Entity\PostType
{
    ...
    {
        // Create posttype
        $postType = new \VolunteerManager\Entity\PostType(
            _x('Assignments', 'Post type plural', 'api-volunteer-manager'),
            _x('Assignment', 'Post type singular', 'api-volunteer-manager'),
            'assignment',
            array(
                'description'          =>   __('Todo support tickets makes it easier to know what to do and improves customer communication.', 'api-volunteer-manager'),
    ...
    public function taxonomyPriority() : string
    {
        ...
        $categories = new \VolunteerManager\Entity\Taxonomy(
        ...
        //Add filter
        new \VolunteerManager\Entity\Filter(
            'todo-priority',
            'assignment'
        );
